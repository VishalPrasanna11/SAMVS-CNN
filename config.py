...
class Config(object):
    def __init__(self, **kwargs):
        ...
        if self.device != 'cpu':
            ...
            torch.cuda.set_device(self.device)  # Set CUDA device
            torch.backends.cudnn.benchmark = True  # Optimizes for GPU with fixed input sizes
        ...
        torch.set_num_threads(12)  # Utilizes all available CPUs (12)
...
def get_config(parse=True, **optional_kwargs):
    ...
    parser.add_argument('--device', type=str, default='cuda:0')  # CUDA device
    ...
    parser.add_argument('--target_width', type=int, default=320)  # Default width
